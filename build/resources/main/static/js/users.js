            ...
            for (let user of data.content) {
              ...
              <tr>
                <td>
                  ...
                  <a href="/users/profile/${user.username}" class="user-link">${user.firstName + ' ' + user.lastName}</a>
                  <span class="user-subhead">ROLES:[${user.userRoles}]</span>
                </td>
                <td><h6>${user.phone}</h6></td>
                <td class="text-center">
                
                <h6 class="userIsActive" >
